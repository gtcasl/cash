...
#define CH_BASIC_INOUT_SCALAR_IMPL(inout_name, field_body, ...) \
  ...
  explicit inout_name(const typename traits::scalar_io& __other) \
    : CH_FOR_EACH(CH_INOUT_SCALAR_COPY_CTOR, , CH_SEP_COMMA, __VA_ARGS__) {} \
  inout_name(const inout_name& __other) \
    : CH_FOR_EACH(CH_INOUT_SCALAR_COPY_CTOR, , CH_SEP_COMMA, __VA_ARGS__) {} \
...
#define CH_BASIC_INOUT_LOGIC_IMPL(inout_name, field_body, ...) \
  ...
  inout_name(const inout_name& __other, CH_SLOC) \
    : CH_FOR_EACH(CH_INOUT_LOGIC_COPY_CTOR, , CH_SEP_COMMA, __VA_ARGS__) {} \
  inout_name(inout_name&& __other) \
    : CH_FOR_EACH(CH_INOUT_MOVE_CTOR, , CH_SEP_COMMA, __VA_ARGS__) {} \
protected: \
...
#define CH_BASIC_INOUT_IMPL(inout_name, ...) \
  ...
  private: \
    ...
    public: \
      using traits = ch::internal::io_traits<CH_STRUCT_SIZE(__VA_ARGS__), __logic_flip_io__, \
        CH_INOUT_FLIP_DIR(__VA_ARGS__), inout_name, __scalar_flip_io__>; \
      CH_BASIC_INOUT_LOGIC_IMPL(__logic_flip_io__, CH_INOUT_LOGIC_FLIP_FIELD, __VA_ARGS__) \
    }; \
    class __scalar_io__ { \
    public: \
      using traits = ch::internal::io_traits<CH_STRUCT_SIZE(__VA_ARGS__), __scalar_io__, \
        CH_INOUT_DIR(__VA_ARGS__), __scalar_flip_io__, inout_name>; \
      CH_BASIC_INOUT_SCALAR_IMPL(__scalar_io__, CH_INOUT_SCALAR_FIELD, __VA_ARGS__) \
    }; \
    class __scalar_flip_io__ { \
    public: \
      using traits = ch::internal::io_traits<CH_STRUCT_SIZE(__VA_ARGS__), __scalar_flip_io__, \
        CH_INOUT_DIR(__VA_ARGS__), __scalar_io__, __logic_flip_io__>; \
  ...
  public: \
    using traits = ch::internal::io_traits<CH_STRUCT_SIZE(__VA_ARGS__), inout_name, \
      CH_INOUT_DIR(__VA_ARGS__), __logic_flip_io__, __scalar_io__>; \
...
#define CH_DERIVED_INOUT_IMPL(inout_name, parent, ...) \
  ...
  private: \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<ch_width_v<base> + CH_STRUCT_SIZE(__VA_ARGS__), __logic_flip_io__, \
        ch_direction_v<base> | CH_INOUT_FLIP_DIR(__VA_ARGS__), inout_name, __scalar_flip_io__>; \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<ch_width_v<base> + CH_STRUCT_SIZE(__VA_ARGS__), __scalar_io__, \
        ch_direction_v<base> | CH_INOUT_FLIP_DIR(__VA_ARGS__), __scalar_flip_io__, inout_name>; \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<ch_width_v<base> + CH_STRUCT_SIZE(__VA_ARGS__), __scalar_flip_io__, \
        ch_direction_v<base> | CH_INOUT_DIR(__VA_ARGS__), __scalar_io__, __logic_flip_io__>; \
  ...
  public: \
    ...
    using traits = ch::internal::io_traits<ch_width_v<base> + CH_STRUCT_SIZE(__VA_ARGS__), inout_name, \
      ch_direction_v<base> | CH_INOUT_DIR(__VA_ARGS__), __logic_flip_io__, __scalar_io__>; \
