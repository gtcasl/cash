...
#define CH_SCALAR_INT_OP1(i, x) \
  CH_FRIEND_OP1_IMPL((), <, const ch_scint&, x) \
  CH_FRIEND_OP1_IMPL((), <=, const ch_scint&, x) \
  CH_FRIEND_OP1_IMPL((), >, const ch_scint&, x) \
  CH_FRIEND_OP1_IMPL((), >=, const ch_scint&, x)
...
#define CH_SCALAR_INT_OP2(i, x) \
  CH_FRIEND_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), <, const ch_scint&, x) \
  CH_FRIEND_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), <=, const ch_scint&, x) \
  CH_FRIEND_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), >, const ch_scint&, x) \
  CH_FRIEND_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), >=, const ch_scint&, x)

#define CH_SCALAR_INT_OP2_TYPES const ch_scint<M>&
...
#define CH_SCALAR_INT_OP5(i, x) \
  CH_FRIEND_OP3_IMPL((), <<, const ch_scint&, x, const ch_scalar<CH_WIDTH_OF(x)>&) \
  CH_FRIEND_OP3_IMPL((), >>, const ch_scint&, x, const ch_scalar<CH_WIDTH_OF(x)>&)
...
#define CH_SCALAR_INT_OP6(i, x) \
  CH_FRIEND_OP3_IMPL((template <unsigned M>), <<, const ch_scint&, x, const ch_scint<M>&) \
  CH_FRIEND_OP3_IMPL((template <unsigned M>), >>, const ch_scint&, x, const ch_scint<M>&)
...
public:
  ...
  template <unsigned M>
  auto operator<<(const ch_scint<M>& rhs) const {
