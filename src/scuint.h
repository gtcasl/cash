...
#define CH_SCALAR_UINT_OP1(i, x) \
  CH_SCALAR_OP1_IMPL((), <, const ch_scuint&, x) \
  CH_SCALAR_OP1_IMPL((), <=, const ch_scuint&, x) \
  CH_SCALAR_OP1_IMPL((), >, const ch_scuint&, x) \
  CH_SCALAR_OP1_IMPL((), >=, const ch_scuint&, x)
...
#define CH_SCALAR_UINT_OP5(i, x) \
  CH_SCALAR_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), <, const ch_scuint&, x) \
  CH_SCALAR_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), <=, const ch_scuint&, x) \
  CH_SCALAR_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), >, const ch_scuint&, x) \
  CH_SCALAR_OP2_IMPL((template <unsigned M, CH_REQUIRE_0(M < N)>), >=, const ch_scuint&, x)
...
#define CH_SCALAR_UINT_OP3(i, x) \
  CH_SCALAR_OP3_IMPL((), <<, const ch_scuint&, x, const ch_scalar<CH_WIDTH_OF(x)>&) \
  CH_SCALAR_OP3_IMPL((), >>, const ch_scuint&, x, const ch_scalar<CH_WIDTH_OF(x)>&)
...
#define CH_SCALAR_UINT_OP4(i, x) \
  CH_SCALAR_OP4_IMPL((), <<, const ch_scuint<CH_WIDTH_OF(x)>&, x, const ch_scuint&) \
  CH_SCALAR_OP4_IMPL((), >>, const ch_scuint<CH_WIDTH_OF(x)>&, x, const ch_scuint&)
...
public:
  ...
  auto operator-() const {
    return make_scalar_op<ch_scuint>(*this, Neg);
  }
