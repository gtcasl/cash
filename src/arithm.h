...
#define CH_BINOP_GEN(func, op) \
  template <typename A, typename B, \
            ...
            CH_REQUIRES(is_cast_convertible<A, ch_bit<deduce_bitcount<A, B>::value>>::value), \
            CH_REQUIRES(is_cast_convertible<B, ch_bit<deduce_bitcount<A, B>::value>>::value)> \
...
#define CH_SHIFTOP_GEN(func, op) \
  template <typename A, typename B, \
            ...
            CH_REQUIRES(is_cast_convertible<A, ch_bit<first_bitcount<A, B>::value>>::value), \
            CH_REQUIRES(is_cast_convertible<B, ch_bit<first_bitcount<B, A>::value>>::value)> \
  const auto op(const A& a, const B& b) { \
    return func(a, b); \
  }
...
template <typename I, typename S,
          CH_REQUIRES(is_cast_convertible<I, ch_bit<I::bitcount>>::value),
          CH_REQUIRES(is_cast_convertible<S, ch_bit<S::bitcount>>::value)>
