...
#define CH_INOUT_IMPL2(inout_name, ...) \
  ...
  private: \
    ...
    public: \
      using traits = ch::internal::io_traits<__flip_device_type__, \
        CH_INOUT_DIRECTION(__VA_ARGS__), __flop_device_type__, __flip_type__, __logic_type__>; \
      CH_INOUT_DEVICE_IMPL2(__flip_device_type__, CH_INOUT_DEVICE_FLIP_FIELD, __VA_ARGS__) \
    }; \
    class __flop_device_type__ { \
    public: \
      using traits = ch::internal::io_traits<__flop_device_type__, \
        CH_INOUT_DIRECTION(__VA_ARGS__), __flip_device_type__, inout_name, __logic_type__>; \
    ...
    public: \
      using traits = ch::internal::io_traits<__flip_type__, \
        CH_INOUT_FLIP_DIRECTION(__VA_ARGS__), inout_name, __flip_device_type__, __logic_type__>; \
      CH_INOUT_LOGIC_IMPL2(__flip_type__, CH_INOUT_FLIP_FIELD, __VA_ARGS__) \
    }; \
  public: \
    using traits = ch::internal::io_traits<inout_name, \
      CH_INOUT_DIRECTION(__VA_ARGS__), __flip_type__, __flop_device_type__,__logic_type__>; \
...
#define CH_INOUT_IMPL3(inout_name, parent, ...) \
  ...
  private: \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<__flip_device_type__, \
        ch_direction(ch_direction_v<base> | CH_INOUT_DIRECTION(__VA_ARGS__)), \
        __flop_device_type__, __flip_type__, __logic_type__>; \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<__flop_device_type__, \
        ch_direction(ch_direction_v<base> | CH_INOUT_FLIP_DIRECTION(__VA_ARGS__)), \
        __flip_device_type__, inout_name, __logic_type__>; \
    ...
    public: \
      ...
      using traits = ch::internal::io_traits<__flip_type__, \
        ch_direction(ch_direction_v<base> | CH_INOUT_FLIP_DIRECTION(__VA_ARGS__)), \
        inout_name, __flip_device_type__, __logic_type__>; \
  ...
  public: \
    ...
    using traits = ch::internal::io_traits<inout_name, \
      ch_direction(ch_direction_v<base> | CH_INOUT_DIRECTION(__VA_ARGS__)), \
      __flip_type__, __flop_device_type__, __logic_type__>; \
