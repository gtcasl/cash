...
TEST_CASE("memory", "[memory]") {
  SECTION("rom", "[rom]") {
    TEST([]()->ch_bit1 {
      ...
      q = rom.read(a);
      a.next = a + 1;
      ch_bit4 e = ch_case(ch_time(), 2, 0xA_h)(4, 0xB_h)(6, 0xC_h)(8, 0xD_h)(10,0xA_h)(q);
    ...
    TEST([]()->ch_bit1 {
      ...
      a.next = a + 1;
      ch_bit4 e = ch_case(ch_time(), 3, 0xA_h)(5, 0xB_h)(7, 0xC_h)(9, 0xD_h)(11,0xA_h)(q);
      //ch_print("t={0}, a={1}, q={2}", ch_time(), a, q);
      return (e == q);
    }, 12);
  }
  ...
  SECTION("ram", "[ram]") {
    TEST([]()->ch_bit1 {
      ...
      ch_bit4 e = ch_case(ch_time(), 3, 0xB_h)(5, 0xA_h)(7, 0xC_h)(9, 0xE_h)(11,0xD_h)(q);
    ...
    TEST([]()->ch_bit1 {
      ...
      ch_tie(a, d, en) = ch_delay(
        ch_case(ch_time(),
          ...
          (10,ch_cat(11_b, 0x0_h, 0_b))
             (ch_cat(00_b, 0x0_h, 0_b)));
      ch_bit4 e = ch_case(ch_time(), 3, 0xA_h)(5, 0xB_h)(7, 0xA_h)(9, 0xC_h)(11,0xE_h)(q);
      //ch_print("t={0}, a={1}, d={2}, en={3}, q={4}, e={5}", ch_time(), a, d, en, q, e);
      return (q == e);
    }, 12);
    TEST([]()->ch_bit1 {
      ch_ram<Q_t, 2> mem;
  ...
  SECTION("partial_write", "[partial_write]") {
    ...
    /*TEST([]()->ch_bit1 {
      ...
      auto e1 = ch_delay(0001_b);
      auto e2 = ch_delay(1000_b);
      ch_print("t={0}, x={1}, e1={2}, y={3}, e2={4}", ch_time(), x, e1, y, e2);
      return (x == e1 && y == e2);
    }, 4);*/
  }
}
